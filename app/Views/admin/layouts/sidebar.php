<?php if (session('role') == 'admin'): ?>
    <div class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            <img src="<?= base_url('assets/images/logo.png') ?>" alt="Vixs Barbershop" onerror="this.src='https://ui-avatars.com/api/?name=Awan+Barbershop&background=A27B5C&color=fff'">
            <div>
                <h3>VIXS</h3>
                <p>Barbershop</p>
            </div>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?= ($title == 'Manajemen Galeri' || $title == 'Tambah Galeri' || $title == 'Edit Galeri') ? 'active' : '' ?>" href="<?= site_url('admin/galeri') ?>">
