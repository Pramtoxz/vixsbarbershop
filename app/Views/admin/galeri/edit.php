    ...
    <div class="galeri-container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="mb-0 text-muted">Perbarui informasi galeri</p>
            </div>
        ...
        <div class="card galeri-card">
            <div class="card-header">
                <h5><i class="fas fa-edit"></i> Form Edit Galeri</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="<?= esc($galeri['nama']) ?>" placeholder="Masukkan nama galeri" required>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="file-upload-wrapper" id="fileUploadWrapper">
                                    <input type="file" class="file-upload-input" id="gambar" name="gambar" accept="image/*">
                            ...
                            <div class="d-flex gap-3 justify-content-end">
                                ...
                                <button type="submit" class="btn btn-primary" id="btnSubmit">
                                    <i class="fas fa-save"></i> Perbarui Galeri
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    $(document).ready(function() {
        ...
        fileInput.on('change', function() {
            ...
            if (file) {
                ...
                imagePreview.hide();
                uploadWrapper.find('.file-upload-content').show();
            }
        });
        ...
        $('#galeriForm').on('submit', function(e) {
            ...
            // Submit form
            $.ajax({
                url: '<?= site_url('admin/galeri/update/' . $galeri['id']) ?>',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        $('#btnSubmit').prop('disabled', false).html('<i class="fas fa-save"></i> Perbarui Galeri');
                    }
                },
                error: function() {
