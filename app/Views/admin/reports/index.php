                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                            Laporan Booking Pertanggal</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Data Booking Pertanggal</div>
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                            Laporan Pembayaran Perbulan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Data Pembayaran Per Bulan</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card border-left-danger shadow h-100 py-2">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <a href="<?= site_url('admin/reports/pembayaran-pertanggal') ?>" class="btn btn-danger btn-sm">
                                        <i class="fas fa-eye"></i> Lihat Laporan
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card border-left-danger shadow h-100 py-2">
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <a href="<?= site_url('admin/reports/pembayaran-pertahun') ?>" class="btn btn-danger btn-sm">
                                        <i class="fas fa-eye"></i> Lihat Laporan
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card border-left-primary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Laporan Uang Masuk Bulanan</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">Uang Masuk Bulanan</div>
                                    </div>
                                    <div class="col-auto">
