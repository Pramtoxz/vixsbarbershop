...
<head>
    ...
    <title>Login - Vixs Barbershop Admin</title>
        ...
        <div class="login-container">
            <div class="login-card position-relative">
                ...
                <div class="login-header">
                    <img src="<?= base_url('assets/images/logo.png') ?>" alt="Vixs Barbershop" class="brand-logo" onerror="this.src='https://ui-avatars.com/api/?name=Awan+Barbershop&background=A27B5C&color=fff'">
